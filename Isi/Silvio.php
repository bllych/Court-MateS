...
<head>
  <title>Coach Silvio</title>
  <link rel="stylesheet" href="../../style/Silvio.css" />
...
<body>
  ...
  <div class="gambarbg">
    <div class="gambar">
      <img src="../../Gambar/Coach/2.png" alt="" />
    </div>
    ...
    <div class="border">
      ...
      <div class="kotak-rate">
        <div class="rate1">
          <h3>Offense</h3>
          <h2 style="margin-left: 40px">5</h2>
        </div>
        <div class="rate1">
          <h3>Defense</h3>
          <h2 style="margin-left: 24px">-31</h2>
        </div>
        <div class="rate1">
          <h3>Position</h3>
          <h2 style="margin-left: 40px">1</h2>
        </div>
        <div class="rate1">
          <h3>Height</h3>
          <h2 style="margin-left: 18px">5'7</h2>
        </div>
      </div>

      <div class="harga">
        <h2 style="margin-bottom: 20px; font-size: 30px">Cost :</h2>
        <div style="display: flex">
          <h1>Rp1</h1>
          <p style="margin-top: 28px; margin-left: 8px">persession</p>
        </div>
      </div>


      <div class="order">
        <a href="../../Isi/Payment Coach Silvio.php"><button><b>Order</b></button></a>
      </div>
    </div>
  </div>
  ...
  <div class="desc">
    ...
    <div class="award">
      <h1>Award :</h1>
      <p>
        Juara 1 semua pertandingan basket Pontianak. Membuat hatimu terpelet
      </p>
    </div>
    ...
    <div class="borderrate">
      <div class="khusu">
        <div class="gambar1">
          <img src="../../Gambar/Coach list Sil/1.png" alt="" />
        </div>
        <div class="ratedesc" style="margin-top: 7px">
          <div class="name" style="display: flex; gap: 5px">
            <h4>P.Berenang</h4>
            <p style="font-size: 11px; padding-top: 2px">Rating : 0/5</p>
          </div>
          <h4>sangat profesional</h4>
        </div>
      </div>
      <hr />
      <div class="khusu">
        <div class="gambar1">
          <img src="../../Gambar/Coach list Sil/2.png" alt="" />
        </div>
        <div class="ratedesc" style="margin-top: 7px">
          <div class="name" style="display: flex; gap: 5px">
            <h4>Karina</h4>
          ...
          <h4>어머... 오빠의 플레이 방식이 너무 좋아요.</h4>
        </div>
      </div>
      <hr />
      <div class="khusu">
        <div class="gambar1">
          <img src="../../Gambar/Coach list Sil/3.png" alt="" />
        </div>
        <div class="ratedesc" style="margin-top: 7px">
          <div class="name" style="display: flex; gap: 5px">
            <h4>Jeni...</h4>
          ...
          <h4>omaigattttt..... GANTENG BANGET</h4>
        </div>
      </div>
      <hr />
      <div class="khusu">
        <div class="gambar1">
          <img src="../../Gambar/Coach list Sil/4.png" alt="" />
        </div>
        <div class="ratedesc" style="margin-top: 7px">
          <div class="name" style="display: flex; gap: 5px">
            <h4>Arthur</h4>
          ...
          <h4>ggggggaaaaaaasssssss diiiii seeeeeewwwwwwaaaaa</h4>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="gambar-info-box">
      ...
      <div class="fotopayment">
        <div class="payments1">
          ...
          <a href="../../Gambar/https://gopay.co.id/"><img src="foto footer/bayar 2.png" alt="gopay"
